...
public class Almacen {
    ...
    private void initialize() {
        ...
        table = new JTable(new Object[][]{}, new String[]{"Producto","Precio", "Proveedor","Fecha Caducidad", "Cantidad Utilizada", "Merma"});
    ...
    public Almacen(JTextField producto, JTextField cantidad, JTextField fechaCaducidad, JTextField precio,
            JTextField proveedor, JTextField merma) {
        super();
        Producto = producto;
        Cantidad = cantidad;
        FechaCaducidad = fechaCaducidad;
