     ...
     // Eventos ventana Plato
      ...
      //ventana Pedido
            ...
            if (indice != -1) {
        	   ...
        	   System.out.println("Pulsado selección");
               elegirOpcion();
   	 ...
   	 private void elegirOpcion() {
         String seleccionado = (String) gastos.getSeleccion().getSelectedItem();
         switch (seleccionado) {
             case "Listar por Proveedor":
   	...
   	private void buscarGastosPorMes() {
   	    ...
   	    List<Gasto> gastosList = daoGastos.listarPorMes(mes, anio);
   	    gastos.actualizarTablaGastos(gastosList);
   	}
